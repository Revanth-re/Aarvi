  ...
  return (
    <html lang="en" data-theme="lavender-light" data-font="sora" suppressHydrationWarning>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Lora:wght@400;500;600;700&family=Fredoka:wght@400;500;600;700&family=Righteous&display=swap" rel="stylesheet"/>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          try {
            ...
            var fonts = ['sora','serif','playful','retro'];
